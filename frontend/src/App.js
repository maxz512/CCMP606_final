...
function App() {
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await axios.post(`http://44.210.115.187:3000/patients/${patientId}`, patientData);
    ...
    const handleRetrieve = async () => {
        try {
            const response = await axios.get(`http://44.210.115.187:3000/patients/${patientId}`);
